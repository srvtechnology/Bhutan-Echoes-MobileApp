...
const typography = {
  fontFamily: {
    regular: Platform.OS === "ios" ? "System" : "poppins",
    medium: Platform.OS === "ios" ? "System" : "poppinsMedium",
    semiBold: Platform.OS === "ios" ? "System" : "poppinsSemiBold",
    bold: Platform.OS === "ios" ? "System" : "poppinsBold",
    extraBold: Platform.OS === "ios" ? "System" : "poppinsExtraBold",
    black: Platform.OS === "ios" ? "System" : "poppinsBlack",
  },
  fontSize: {
    xs: 12,
    sm: 14,
